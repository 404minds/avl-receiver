...
func NewTcpHandler(remoteStoreClient store.CustomAvlDataStoreClient, storeType string) TcpHandler {
	return TcpHandler{
		...
		allowedProtocols:  []types.DeviceProtocolType{types.DeviceProtocolType_TR06, types.DeviceProtocolType_GT06, types.DeviceProtocolType_FM1200}, // registered device types can be made configurable to enable/disable a device-type at once
