...
func (x *DeviceStatus) GetHowenPacket() *HowenPacket {
	if x, ok := x.GetRawData().(*DeviceStatus_HowenPacket); ok {
...
type DeviceStatus_WanwayPacket struct {
	WanwayPacket *WanwayPacket `protobuf:"bytes,16,opt,name=wanway_packet,json=wanwayPacket,proto3,oneof"`
}

type DeviceStatus_TeltonikaPacket struct {
	TeltonikaPacket *TeltonikaPacket `protobuf:"bytes,17,opt,name=teltonika_packet,json=teltonikaPacket,proto3,oneof"`
}

type DeviceStatus_ConcoxPacket struct {
	ConcoxPacket *ConcoxPacket `protobuf:"bytes,18,opt,name=concox_packet,json=concoxPacket,proto3,oneof"`
}

type DeviceStatus_HowenPacket struct {
	HowenPacket *HowenPacket `protobuf:"bytes,19,opt,name=howen_packet,json=howenPacket,proto3,oneof"`
}
...
var file_common_types_proto_rawDesc = []byte{
	...
	0x03, 0x72, 0x70, 0x6d, 0x12, 0x3a, 0x0a, 0x0d, 0x77, 0x61, 0x6e, 0x77, 0x61, 0x79, 0x5f, 0x70,
	0x61, 0x63, 0x6b, 0x65, 0x74, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x79,
	...
	0x63, 0x6b, 0x65, 0x74, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x74, 0x79, 0x70,
	...
	0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74,
	...
	0x74, 0x12, 0x37, 0x0a, 0x0c, 0x68, 0x6f, 0x77, 0x65, 0x6e, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x65,
	0x74, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e,
	0x48, 0x6f, 0x77, 0x65, 0x6e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x48, 0x00, 0x52, 0x0b, 0x68,
	0x6f, 0x77, 0x65, 0x6e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x42, 0x0a, 0x0a, 0x08, 0x72, 0x61,
	...
	0x0c, 0x52, 0x07, 0x72, 0x61, 0x77, 0x44, 0x61, 0x74, 0x61, 0x22, 0x40, 0x0a, 0x0e, 0x44, 0x65,
	...
	0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2d, 0x0a, 0x17,
	0x46, 0x65, 0x74, 0x63, 0x68, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x6d, 0x65, 0x69, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x6d, 0x65, 0x69, 0x22, 0x30, 0x0a, 0x18, 0x46,
	...
	,
	...
	0x69, 0x76, 0x65, 0x72, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x74, 0x79,
...
func file_common_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_common_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_common_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_common_types_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_common_types_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_common_types_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*HowenPacket); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_common_types_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_common_types_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*FetchDeviceModelRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_common_types_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*FetchDeviceModelResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
