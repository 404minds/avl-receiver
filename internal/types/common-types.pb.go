...
type DeviceStatus_WanwayPacket struct {
	WanwayPacket *WanwayPacket `protobuf:"bytes,11,opt,name=wanway_packet,json=wanwayPacket,proto3,oneof"`
}

type DeviceStatus_TeltonikaPacket struct {
	TeltonikaPacket *TeltonikaPacket `protobuf:"bytes,12,opt,name=teltonika_packet,json=teltonikaPacket,proto3,oneof"`
}

type DeviceStatus_ConcoxPacket struct {
	ConcoxPacket *ConcoxPacket `protobuf:"bytes,13,opt,name=concox_packet,json=concoxPacket,proto3,oneof"`
}
...
var file_common_types_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xeb, 0x04, 0x0a,
	...
	0x65, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73,
	...
	0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e,
	...
	0x6b, 0x65, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x79, 0x70, 0x65,
