...
var ErrTeltonikaUnauthorizedDevice = fmt.Errorf("unauthorized teltonika device - %w", ErrUnauthorizedDevice)
...
var ErrWanwayUnauthorizedDevice = fmt.Errorf("unauthorized wanway device - %w", ErrUnauthorizedDevice)
