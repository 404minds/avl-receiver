...
const (
	...
	AvlDataStore_SaveDeviceReply_FullMethodName  = "/store.AvlDataStore/SaveDeviceReply"
)
...
type AvlDataStoreClient interface {
	...
	SaveDeviceReply(ctx context.Context, in *types.DeviceResponse, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *avlDataStoreClient) SaveDeviceReply(ctx context.Context, in *types.DeviceResponse, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AvlDataStore_SaveDeviceReply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AvlDataStoreServer interface {
	...
	SaveDeviceReply(context.Context, *types.DeviceResponse) (*emptypb.Empty, error)
...
func (UnimplementedAvlDataStoreServer) SaveDeviceReply(context.Context, *types.DeviceResponse) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveDeviceReply not implemented")
}
...
func _AvlDataStore_SaveDeviceReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(types.DeviceResponse)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AvlDataStoreServer).SaveDeviceReply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AvlDataStore_SaveDeviceReply_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AvlDataStoreServer).SaveDeviceReply(ctx, req.(*types.DeviceResponse))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AvlDataStore_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SaveDeviceReply",
			Handler:    _AvlDataStore_SaveDeviceReply_Handler,
		},
	},
